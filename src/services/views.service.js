...
const getAll = () => {
    return fetch("https://8f146194-0c00-45d2-aaed-d3c94395bd43-00-1h6pryaiftp3x.spock.replit.dev/views")
        .then((response) => {
...
const getUser = (id) => {
    return fetch("https://8f146194-0c00-45d2-aaed-d3c94395bd43-00-1h6pryaiftp3x.spock.replit.dev/views/users/" + id)
        .then((response) => {
            if (response.status === 200) {
                return response.json();
            } else {
...
const getProduct = (id) => {
    return fetch("https://8f146194-0c00-45d2-aaed-d3c94395bd43-00-1h6pryaiftp3x.spock.replit.dev/views/products/" + id)
        .then((response) => {
            if (response.status === 200) {
                return response.json();
            } else {
...
const getOne = (id) => {
    return fetch("https://8f146194-0c00-45d2-aaed-d3c94395bd43-00-1h6pryaiftp3x.spock.replit.dev/views/" + id)
        .then((response) => {
            if (response.status === 200) {
                return response.json();
            } else {
